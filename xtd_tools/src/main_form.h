...
namespace xtd_tools {
  ...
  private:
    ...
    xtd::forms::menu_item tools_color_converter_menu_item {"&Color converter", {*this, &main_form::creates_tool<color_converter>}};
    xtd::forms::menu_item tools_style_sheet_renderer_menu_item {"&Style sheet renderer", {*this, &main_form::creates_tool<style_sheet_renderer>}};
